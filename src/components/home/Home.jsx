...
import sharedStyled from '../shared.module.css';
        ...
        <div class={styles.container}>
            ...
            <div class={styles.mainMessageContainer}>
                <div class={styles.titleContainer}>
                    <span class={sharedStyled.title}>Free Assets for You!</span>
                ...
                <Entry title={entry1.name} previewUrl={entry1.previewUrl} downloads={entry1.downloads}/>
            </div>
            
            <div class={styles.secondaryMessageContainer}>
                <Entry title={entry2.name} previewUrl={entry2.previewUrl} downloads={entry2.downloads} />

                <div class={styles.titleContainer}>
                    <span class={sharedStyled.title}>Made with Love and Care.</span>
